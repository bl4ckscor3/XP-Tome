...
public class XPTome {
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Double>> RETRIEVAL_PERCENTAGE = DATA_COMPONENTS.registerComponentType("retrieval_percentage", builder -> builder.persistent(Codec.DOUBLE.validate(XPTome::validateRetrievalPercentage)).cacheEncoding());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> RETRIEVE_XP_ORBS = DATA_COMPONENTS.registerComponentType("retrieve_xp_orbs", builder -> builder.persistent(Codec.unit(Unit.INSTANCE)).cacheEncoding());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> RETRIEVE_UNTIL_NEXT_LEVEL = DATA_COMPONENTS.registerComponentType("retrieve_until_next_level", builder -> builder.persistent(Codec.unit(Unit.INSTANCE)).cacheEncoding());
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Unit>> STORE_UNTIL_PREVIOUS_LEVEL = DATA_COMPONENTS.registerComponentType("store_until_previous_level", builder -> builder.persistent(Codec.unit(Unit.INSTANCE)).cacheEncoding());
	...
	public static final DeferredItem<XPTomeItem> XP_TOME = ITEMS.register("xp_tome", () -> new XPTomeItem(new Item.Properties().stacksTo(1).component(STORED_XP, 0).component(MAXIMUM_XP, XPTomeItem.DEFAULT_MAX_XP).component(RETRIEVAL_PERCENTAGE, 1.0D)));
